...
import no.imr.nmdapi.stox.converters.mapper.DatasetNamespacePrefixMapper;
import no.imr.nmdapi.stox.converters.mapper.ResponseNamespacePrefixMapper;
import no.imr.nmdapi.stox.converters.mapper.StoxPrefixMapper;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    /**
     * Creates the xml converter for stox.
     *
    ...
    public HttpMessageConverter getEchoMappingJaxBHttpMessageConverter() {
        ...
        try {
            converter = new JAXBHttpMessageConverter(new StoxPrefixMapper(),
